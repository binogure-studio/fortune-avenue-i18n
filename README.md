# [Fortune Avenue](https://www.fortune-avenue.com) translations

A repository for Fortune Avenue's translation efforts. There are only two folders:

- **languages** contains a list of files for every supported languages
- [**steam-page**](store.steampowered.com/app/1810050/Fortune_Avenue//) contains two files for every supported languages, one for the short description, one for the long description
...
# Here's a mapping of a hypothetical Fortune Avenue phrase:
...
If you have questions about contributing [contact us](https://www.fortune-avenue.com)
